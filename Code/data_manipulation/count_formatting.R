#This file takes the individual data for B cell counts and builds a .txt file
...
MLN_OUTPUT <- "~/Desktop/CobeyLab/bcell_id_pop_model/Data/transformations/mln_bcell_count_means.txt"
SPLN_OUTPUT <- "~/Desktop/CobeyLab/bcell_id_pop_model/Data/transformations/spln_bcell_count_means.txt"


setwd(WD)

b_freq <- read.csv('GC_B_Count.csv',header=TRUE,stringsAsFactors = FALSE)
